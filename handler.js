        ...
        case 'remove':
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    let pp = './views/avatar_contact.png'
                    try {
...
global.dfail = (type, m, conn) => {
    let msg = { 
       ...
       unreg: '🗿𝙃𝙊𝙇𝘼 𝘼𝙈𝙄𝙂@ 𝘽𝙄𝙀𝙉𝙑𝙀𝙉𝙄𝘿𝙊 𝘼 𝙇𝘼 𝘾𝙊𝙈𝙐𝙉𝙄𝘿𝘼𝘿 ❞𝙏𝙄𝙇𝙄𝙉𝙀𝙎❞ 𝙈𝙐𝘾𝙃𝘼𝙎 𝙂𝙍𝘼𝘾𝙄𝘼𝙎 𝙋𝙊𝙍 𝙐𝙎𝘼𝙍 𝙀𝙎𝙏𝙀 𝘽𝙊𝙏.𝙋𝘼𝙍𝘼 𝙐𝙎𝘼𝙍 𝙇𝙊𝙎 𝘾𝙊𝙈𝘼𝙉𝘿𝙊𝙎 𝙏𝙄𝙀𝙉𝙀𝙎 𝙌𝙐𝙀 𝙍𝙀𝙂𝙄𝙎𝙏𝙍𝘼𝙍𝙏𝙀 𝙀𝙅𝙀𝙈𝙋𝙇𝙊 = /𝙧𝙚𝙜 𝙃𝙖𝙙 .22𝙀𝙎𝙏𝙊 𝙀𝙎 𝙏𝙊𝘿𝙊 𝙎𝙊𝙇𝙊 𝙍𝙀𝙂𝙄𝙎𝙏𝙍𝘼𝙏𝙀 𝙔 𝙐𝙎𝘼𝙍 𝙀𝙇 𝘽𝙊𝙏 𝘽𝙐𝙀𝙉 𝘿𝙄́𝘼👻 '     restrict: '[⚠️ᴬˡᵉʳᵗᵃ ⁱᵐᵖᵒʳᵗᵃⁿᵗᵉ⚠️]\nᴱˢᵗᵉ ᶜᵒᵐᵃⁿᵈᵒ ᴱˢᵗᵃ ᴿᵉˢᵗʳⁱⁿᵍⁱᵈᵒ/ᴰᵉˢᵃᶜᵗⁱᵛᵃ ᴾᵒʳ ᴰᵉˢⁱᶜⁱᵒⁿ ᴰᵉˡ ᴾʳᵒᵖⁱᵉᵗᵃʳⁱᵒ/ᴬ (ᵒʷⁿᵉʳ) ᴰᵉˡ ᴮᵒᵗ'
      }[type]
    let aa = { quoted: m, userJid: conn.user.jid }
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: '𝙱𝙾𝚃 𝙷𝙰𝙳™', thumbnail: imagen1, sourceUrl: 'https://github.com/TILIN89/HATSUNE-MIKU-ULTRA' }}}}, aa)
