...
if wget -q https://github.com/TILIN89/HATSUNE-MIKU-ULTRA/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/TILIN89/HATSUNE-MIKU-ULTRA.git
